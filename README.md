...
THE INput string has size limit of 100000.(AS this is only a small scale application)
...
The html file has data of only present game it will not have any previous data.
